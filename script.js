...
class Workout {
    ...
    constructor(coords, distance, duration) {
        // this.date = date;        old way syntax
        // this.id = id;            old way syntax
    ...
    constructor() {
        ...
        _newWorkout(e) {
            ...
            if (type === 'running') {
                ...
                // if (!Number.isFinite(distance) || !Number.isFinite(duration) || !Number.isFinite(cadence)) - oldchool version
            ...
            // rendering workout on map as a marker
            this._renderWorkoutMarker(workout);
                


            // rendering workout on a list
